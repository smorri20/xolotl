 ...
 */
class ProfileProcHandlerRegistry : public CommonHandlerRegistry {
public:
...
public:
	 ...
	 */
    ProfileProcHandlerRegistry(std::string outputFilename)
	 ...
	 */
	virtual ~ProfileProcHandlerRegistry(void) {
        // Nothing else to do.
    }
