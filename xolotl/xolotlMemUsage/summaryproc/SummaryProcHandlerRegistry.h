#ifndef XMEMUSAGE_SUMMARY_PROC_HANDLER_REGISTRY_H
#define XMEMUSAGE_SUMMARY_PROC_HANDLER_REGISTRY_H
 ...
 */
class SummaryProcHandlerRegistry : public CommonHandlerRegistry {
public:
    /**
...
#endif // XMEMUSAGE_SUMMARY_PROC_HANDLER_REGISTRY_H
