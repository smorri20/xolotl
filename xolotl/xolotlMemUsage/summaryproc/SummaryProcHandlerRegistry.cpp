...
void SummaryProcHandlerRegistry::CollectAllObjectNames(int myRank,
...
template<typename T>
void SummaryProcHandlerRegistry::CollectMyObjectNames(
		const std::map<std::string, std::shared_ptr<T> >& myObjs,
...
template<typename T, typename V>
std::shared_ptr<V> SummaryProcHandlerRegistry::GetObjValue(
		const std::map<std::string, std::shared_ptr<T> >& myObjs,
...
template<typename T, typename V>
void SummaryProcHandlerRegistry::AggregateStatistics(int myRank,
		const std::map<std::string, std::shared_ptr<T> >& myObjs,
		std::map<std::string, MemUsageObjStatistics<V> >& stats) const {
...
template<>
void SummaryProcHandlerRegistry::AggregateStatistics<IMemUsageSampler, MemUsageStats>(int myRank,
...
SummaryProcHandlerRegistry::collectData(void) const {
...
void SummaryProcHandlerRegistry::reportData(std::ostream& os,
