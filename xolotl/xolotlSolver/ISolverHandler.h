...
public:
	 ...
	 */
	virtual int getSurfacePosition() const = 0;

	/**
	 * Set the surface position.
	 *
	 * @param index The surface position index
	 */
	virtual int setSurfacePosition(int index) = 0;
	 ...
	 */
	virtual xolotlCore::IBubbleBurstingHandler *getBubbleBurstingHandler() const = 0;
