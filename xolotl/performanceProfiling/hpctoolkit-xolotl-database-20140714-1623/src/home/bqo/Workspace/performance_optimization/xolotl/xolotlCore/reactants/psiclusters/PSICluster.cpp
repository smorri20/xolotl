...
//	std::cout << getName() << ": "
//			<< reactingPairs.size() << " " << effReactingPairs.size() << ", "
//			<< combiningReactants.size() << " " << effCombiningReactants.size() << ", "
//			<< dissociatingPairs.size() << " " << effDissociatingPairs.size() << ", "
//			<< emissionPairs.size() << " " << effEmissionPairs.size() << std::endl;
//
//
