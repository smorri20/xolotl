...
public:
	 ...
	 *
	 * On the left and right grid point the partial will be D * s with D the diffusion
	 * coefficient, and on this grid point the value of the partial will be -2 * D * s.
	 *
	 * @param network The network
	 * @param s The space parameter, depending on the grid step size
