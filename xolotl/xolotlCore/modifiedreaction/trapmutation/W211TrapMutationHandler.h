...
//		depthVec = {0.5, 0.8, 1.0, 1.0, 1.0, 1.3, 1.5}; // 933 K
//		sizeVec = {1, 1, 1, 2, 2, 2, 1};
		depthVec = {0.5, 0.8, 1.0, 1.0, 1.3, 1.3, 1.2}; // 1200 K
		sizeVec = {1, 1, 1, 2, 1, 2, 3};

		// He1 desorpts with 59%
//		desorp = Desorption(1, 0.64); // 933 K
		desorp = Desorption(1, 0.59); // 1200 K
