...
class DissociationReaction: public KeyedReaction<std::array<IReactant::SizeType, 3*(static_cast<int>(Species::last) + 1)> > {
public:
...
struct hash<xolotlCore::DissociationReaction::KeyType> {
    ...
    size_t operator()(const xolotlCore::DissociationReaction::KeyType& val) const {
