...
double PSISuperCluster::getPade(double distHe, double distV) const {
	...
	denominator = 1.0 + padeCoef[10] * distHe + padeCoef[11] * distV
			...
			+ padeCoef[15] * distHe * distHe * distHe
			+ padeCoef[16] * distV * distV * distV
			+ padeCoef[17] * distHe * distHe * distV
			+ padeCoef[18] * distHe * distV * distV
			+ padeCoef[19] * distHe * distHe * distHe * distHe
			+ padeCoef[20] * distV * distV * distV * distV
			+ padeCoef[21] * distHe * distHe * distHe * distV
			+ padeCoef[22] * distHe * distHe * distV * distV
			+ padeCoef[23] * distHe * distV * distV * distV;
