...
protected:
	...
	/**
	 * The last value of the migration energy, which is stored accelerate the
	 * calculation of the diffusion coefficient.
	 */
	double lastMigrationEnergy;
	 ...
	 * temperature.
	 *
	 * The clusters in this operation are not const-qualified because they may
	 * change the information that they cache when the rate constant is
	 * computed to optimize the call for the future.
	 *
	 ...
	 * @return
	 */
	double calculateReactionRateConstant(PSICluster & firstcluster,
			PSICluster & secondcluster, double temperature);
	 ...
	 * @return
	 */
	double calculateDissociationConstant(PSICluster & firstCluster,
			PSICluster & secondCluster, double temperature);
	 ...
	 */
	virtual void getProductionPartialDerivatives(std::vector<double> & partials, double temperature);
	 ...
	 * @param temperature The temperature at which the reactions are occurring.
	 */
	virtual void getCombinationPartialDerivatives(std::vector<double> & partials, double temperature);
	 ...
	 * @param temperature The temperature at which the reactions are occurring.
	 */
	virtual void getDissociationPartialDerivatives(std::vector<double> & partials, double temperature);
	...
	/**
	 * The last temperature used to compute the diffusion coefficient.
	 */
	double lastDiffusionTemperature = 0.0e-16;

	/**
	 * The last value of the diffusion coefficient
	 */
	double lastDiffusionCoefficient = 0.0e-16;
...
public:
	 ...
	 */
	virtual double getDissociationFlux(double temperature);
	 ...
	 */
	virtual double getProductionFlux(double temperature);
	 ...
	 */
	virtual double getCombinationFlux(double temperature);
	 ...
	 */
	virtual double getDiffusionCoefficient(double temperature);
	 ...
	 */
	virtual std::vector<double> getPartialDerivatives(double temperature);
