 ...
 */
BOOST_AUTO_TEST_SUITE (Td80FitDisplacementHandlerTester_testSuite)
...
BOOST_AUTO_TEST_CASE(checkGetInitialDisplacement) {
    ...
    auto testFitDisplacement = make_shared<Td80FitDisplacementHandler>();
	...
	BOOST_REQUIRE_CLOSE(testDisplacementVec[1], 0.23554258, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[2], 0.12507184, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[3], 0.03934558, 0.01);
...
BOOST_AUTO_TEST_CASE(checkKrFluenceAmplitude) {
	...
	// Check the value at some grid points
	BOOST_REQUIRE_CLOSE(testDisplacementVec[1], 0.58885645, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[2], 0.3126796, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[3], 0.09836396, 0.01);
