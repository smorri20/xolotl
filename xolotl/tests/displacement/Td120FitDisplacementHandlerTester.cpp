 ...
 */
BOOST_AUTO_TEST_SUITE (Td120FitDisplacementHandlerTester_testSuite)
...
BOOST_AUTO_TEST_CASE(checkGetInitialDisplacement) {
    ...
    auto testFitDisplacement = make_shared<Td120FitDisplacementHandler>();
	...
	BOOST_REQUIRE_CLOSE(testDisplacementVec[1], 0.23756289, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[2], 0.12396846, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[3], 0.03842865, 0.01);
...
BOOST_AUTO_TEST_CASE(checkKrFluenceAmplitude) {
	...
	// Check the value at some grid points
	BOOST_REQUIRE_CLOSE(testDisplacementVec[1], 0.59390722, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[2], 0.30992115, 0.01);
	BOOST_REQUIRE_CLOSE(testDisplacementVec[3], 0.09607163, 0.01);
