...
BOOST_AUTO_TEST_CASE(checkBubbleBursting) {
	...
	int nBubble = bubbleBurstingHandler.getNBursting(network, 2);
	int indices[2 * nBubble];
	double val[nBubble];
	...
	BOOST_REQUIRE_EQUAL(indices[1], 48);
	BOOST_REQUIRE_EQUAL(indices[2], 39);
	BOOST_REQUIRE_EQUAL(indices[3], 48);
	BOOST_REQUIRE_EQUAL(indices[4], 49);
	BOOST_REQUIRE_EQUAL(indices[5], 49);
	BOOST_REQUIRE_EQUAL(indices[6], 39);
	BOOST_REQUIRE_EQUAL(indices[7], 49);
