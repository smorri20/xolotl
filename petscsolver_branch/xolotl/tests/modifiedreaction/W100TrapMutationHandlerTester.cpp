...
BOOST_AUTO_TEST_CASE(checkModifiedTrapMutation) {
	...
	concOffset = conc + 7 * size;
	updatedConcOffset = updatedConc + 7 * size;
	...
	// Check the new values of updatedConcOffset
	BOOST_REQUIRE_CLOSE(updatedConcOffset[0], 4.05765e+22, 0.01); // Create I
	...
	BOOST_REQUIRE_CLOSE(updatedConcOffset[13], -2.02897e+22, 0.01); // He8
	BOOST_REQUIRE_CLOSE(updatedConcOffset[22], 2.02897e+22, 0.01); // Create He8V
