...
BOOST_AUTO_TEST_CASE(checkModifiedTrapMutation) {
	...
	BOOST_REQUIRE_CLOSE(updatedConcOffset[0], 2.92139e+21, 0.01); // Create I
	BOOST_REQUIRE_CLOSE(updatedConcOffset[7], -4.16136e+20, 0.01); // He2
	BOOST_REQUIRE_CLOSE(updatedConcOffset[16], 4.16136e+20, 0.01); // Create He2V
	...
	// Check the new values of updatedConcOffset
	BOOST_REQUIRE_CLOSE(updatedConcOffset[0], 2.48251e+23, 0.01); // Create I
	...
	BOOST_REQUIRE_EQUAL(indices[0], 7);
	BOOST_REQUIRE_EQUAL(indices[1], 16);
	BOOST_REQUIRE_EQUAL(indices[2], 0);
	BOOST_REQUIRE_EQUAL(indices[15], 12);
	BOOST_REQUIRE_EQUAL(indices[16], 21);
	BOOST_REQUIRE_EQUAL(indices[17], 0);
